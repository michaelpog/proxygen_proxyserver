...
namespace ProxyService {
    ...
    public:
        ...
        void onDeactivateConnection(const proxygen::HTTPSession &session) override {
            LOG(INFO) <<"max: "<<session.getMaxConcurrentOutgoingStreams()<<" current:"<<session.getNumOutgoingStreams();
        }
